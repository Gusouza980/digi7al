...
<head>
        ...
        <meta charset="utf-8" />
        <title>Digi7al - Painel Administrativo</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Painel de controle da Digi7al" name="description" />
        ...
        <div>
            <div class="container-fluid p-0">
                <div class="row g-0">
                    ...
                    <div class="col-xl-3" style="background-color: #EF2D2D;">
                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mt-4">
                                            <form action="{{route('painel.logar')}}" method="post">
                                                ...
                                                <div class="mt-3 d-grid">
                                                    <button class="btn waves-effect waves-light" style="background-color: white; color:black;" type="submit">Entrar</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center text-white">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Digi7al</p>
                                    </div>
                                </div>
