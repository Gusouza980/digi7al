                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" style="background: #EF2D2D;">
                                <a class="dropdown-item text-white" href="{{route('painel.sair')}}"><i class="bx bx-power-off font-size-16 align-middle me-1 text-white"></i> <span key="t-logout">Logout</span></a>
                            </div>
                        </div>
